...
import { getPropertiesOfAgent } from "../../Services/allApi";
import { Box, Chip, CircularProgress, Dialog, DialogContent, DialogTitle, Grid, Typography } from "@mui/material";
import PropertyCard from "../../Components/PropertyCard";
 ...
 const AgentProperties=()=> {
  ...
  const fetchPropertyOfAgent = async () => {
    try {
      const res = await getPropertiesOfAgent();
    //   console.log("this response from agent properties"); 
    ...
    <>
      ...
      >
        ...
        <Box sx={{ flex: 1 }}>
          ...
          <Typography mb={1}>
            <strong>Deposit:</strong> ₹{selectedProperty?.fixedDepositAmount.toLocaleString()}
          </Typography>
          <Typography mb={1}>
